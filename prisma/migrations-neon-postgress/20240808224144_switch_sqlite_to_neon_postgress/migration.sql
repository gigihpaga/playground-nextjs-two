...
CREATE TABLE "dev_collection" (
    ...
    CONSTRAINT "dev_collection_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "dev_task" (
    ...
    CONSTRAINT "dev_task_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "dev_task" ADD CONSTRAINT "dev_task_collectionId_fkey" FOREIGN KEY ("collectionId") REFERENCES "dev_collection"("id") ON DELETE CASCADE ON UPDATE CASCADE;
