// v6 - Perbaikan logika checkCollisions (v6) dan memperbaiki kode yang salah referensi (v5)
'use client';
...
const Node = ({ node }: { node: NodeProps }) => {
    ...
    const style = {
        width: node.size * GRID_SIZE,
        height: node.size * GRID_SIZE,
...
const App = () => {
    const [nodes, setNodes] = useState<NodeProps[]>([
        { id: 'b1', type: 'building', position: { x: 100, y: 100 }, size: 3 },
