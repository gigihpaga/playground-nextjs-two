...
// v11 - Menambahkan Snap to Grid untuk bola
                        ...
                        setBalls((prevBalls) =>
                            prevBalls.map((ball) =>
                                ball.id === active.id
                                    ? {
                                          ...ball,
                                          x: Math.max(0, Math.min(Math.round((ball.x + delta.x) / GridSize) * GridSize, BoardSize - BallSize)),
                                          y: Math.max(0, Math.min(Math.round((ball.y + delta.y) / GridSize) * GridSize, BoardSize - BallSize)),
                                      }
                                    : ball
                            )
                        );
