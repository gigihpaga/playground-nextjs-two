'use client';
// v3 - Mencegah panning saat user sedang drag ball
...
export function New3() {
    ...
    const [isDragging, setIsDragging] = useState(false); // State untuk mendeteksi drag
    ...
    const handleMouseDown = (event: React.MouseEvent) => {
        if (isDragging) return; // Jika sedang drag ball, abaikan panning
