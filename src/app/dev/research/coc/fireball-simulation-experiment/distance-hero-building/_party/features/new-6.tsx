...
// v6 - Menambah visualisasi jarak antar bola
            ...
            >
                <DndContext
                    ...
                    onDragMove={(event) => {
                        ...
                        const activeBall = balls.find((ball) => ball.id === active.id);
                        console.log('onDragMove', { active, delta, activeBall });
                    }}
                    onDragEnd={(event) => {
                        setIsDragging(false);
                        const { active, delta } = event;
