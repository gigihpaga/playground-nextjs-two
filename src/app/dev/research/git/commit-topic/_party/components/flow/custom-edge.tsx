...
export const EdgeCustomDataSchema = z.object({
...
export type EdgeCustomData = z.infer<typeof EdgeCustomDataSchema>;

export type EdgeCustomProps = PartiallyRequired<Edge<EdgeCustomData, 'custom-edge'>, 'type'>;

export function CustomEdge(props: EdgeProps<EdgeCustomProps>) {
    ...
    return (
        <>
            <BaseEdge
                ...
                style={{
                    strokeWidth: 2,
                    stroke: props.selected ? '#7CD9FF' /* '#4227d8'  */ : '#d82776',
                }}
            />
