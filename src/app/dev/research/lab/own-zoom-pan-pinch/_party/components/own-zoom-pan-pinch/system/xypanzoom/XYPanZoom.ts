...
import { type CoordinateExtent, type Viewport, PanZoomTransformOptions, PanZoomUpdateOptions, PanZoomParams, PanZoomInstance } from '../types';
...
export function XYPanZoom({
    ...
    console.log('XYPanZoom:domNode', domNode);
