...
/**
 * reference:
 * - [github React Vis Timelin](https://github.com/razbensimon/react-vis-timeline/blob/master/src/timeline.tsx)
 */
export class Timeline extends Component<Props, {}> {
    ...
    init() {
        const { initialItems, initialGroups, options, selection, selectionOptions = {}, customTimes, animate = true, currentTime } = this.props;
