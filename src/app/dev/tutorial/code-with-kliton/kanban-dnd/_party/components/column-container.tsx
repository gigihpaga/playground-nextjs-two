...
export function ColumnContainer({ column, deleteColum, updateColumnName, createTask, tasks, deleteTask, updateTask }: Props) {
    ...
    if (isDragging) {
        return (
            <div
                ref={setNodeRef}
                style={style}
                className="bg-[#161C22] w-[350px] h-[500px] max-h-[500px] rounded-md flex flex-col border border-rose-500 opacity-40"
            />
        );
    }
        ...
        >
            ...
            >
                <div className="flex gap-2">
                    ...
                    {isEditMode ? (
                        <input
                            className="bg-white text-black font-normal focus:border-rose-500 border rounded outline-none px-2"
