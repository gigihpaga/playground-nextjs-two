import { Status, useTaskStore } from '../state/task-store';
import { cn } from '@/lib/classnames';

export default function Task({ id, title, description, status }: { id: string; title: string; description?: string; status: Status }) {
