...
import { Item, List, Wrapper } from '@/app/dev/tutorial/official-dnd-kit/_party/components';
...
export function Sortable(_props: Props) {
    const {
    ...
    const [items, setItems] = useState<UniqueIdentifier[]>(() => initialItems ?? createRange<UniqueIdentifier>(itemCount, (index) => index));
...
export function SortableItem(_props: SortableItemProps) {
    const { disabled, animateLayoutChanges, getNewIndex, handle, id, index, onRemove, style, renderItem, useDragOverlay, wrapperStyle } = _props;
